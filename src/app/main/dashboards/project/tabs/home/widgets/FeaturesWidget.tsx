...
function FeaturesWidget({ value = 0 }: FeaturesWidgetProps) {
	console.log('FeaturesWidget value:', value);

	const { data: widgets, isLoading } = useGetProjectDashboardWidgetsQuery();
	const widget = widgets?.features as WidgetDataType | undefined;
	...
	return (
		<Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden">
			...
			<div className="text-center mt-8">
				<Typography
					className="text-3xl sm:text-3xl font-bold tracking-tight leading-none text-red-600"
				>
