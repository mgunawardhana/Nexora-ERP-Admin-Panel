...
function Category(): JSX.Element {
	...
	const handleRowDelete = useCallback((rowData: Category): void => {
	...
	const handleEdit = useCallback((rowData: Category): void => {
		setSelectedEditRowData({
			...
			isActive: true, // Adjust based on actual data
		});
		toggleEditModal();
	}, [toggleEditModal]);
